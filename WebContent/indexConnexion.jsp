...
<head>
    ...
    <title>Réservation Salle ICS</title>
</head>
...
<body>
    ...
    <header>
		...
		<p>
            ...
            <div class="title_top">
                <a href="index.html">
                    <h1 class="first_title">ICS réservation de salle</h1>
                </a>
            </div>
    ...
    <section id="test">
        <aside>
            <div id="dateSearch">
                <label for="start">Veuillez entrez votre date de réservation:</label>
            ...
            <div class="row">
                <div class="col-sm-3">
                    <div class="card" style="width: 20rem;">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Réservé par<span class="name"> Rémi </span><br>
                                Date et heure de réservation<span class="date"> 30 Février de 13H00 à 14H00</span>
                            </p>
                            <div class="card-bottom-btn">
                                <a href="HTML/reservation.html" class="btn btn-primary">Réservation</a>
                ...
                <div class="col-sm-3">
                    <div class="card" style="width: 20rem;">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Théo <span class="capacites">(20 Places)</span></h5>
                            <p class="card-text">Réservé par<span class="name"> Rémi </span><br>
                                Date et heure de réservation<span class="date"> 30 Février de 13H00 à 14H00</span>
                            </p>
                            <div class="card-bottom-btn">
